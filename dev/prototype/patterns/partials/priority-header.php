<header class="priority-header">
  ...
  <video playsinline loop muted autoplay poster="../../assets/img/fountain-poster.jpg" class="priority-header__video" id="bgvid">
        <source src="../../assets/video/fountain-small.webm" type="video/webm" media="all and (min-width:800px)">
        <source src="../../assets/video/fountain-small.mp4" type="video/mp4" media="all and (min-width:800px)">
  </video>
