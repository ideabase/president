...
<figure class="gallery__item">
			    <img class="gallery__item__image" src="{{ site.url }}/assets/img/gallery/crop/breakthrough.jpg" alt="More than 400 marketing pieces were created following the creation of the new brand identity." />
			    <figcaption>
